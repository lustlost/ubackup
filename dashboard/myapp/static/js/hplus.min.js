...
$(window).bind("load resize", function () {
    ...
    //    var e = localStorage.getItem("fixednavbar");
    //    var i = localStorage.getItem("boxedlayout");
    //    var l = $("body"); "on" == a && (l.hasClass("body-small") || l.addClass("mini-navbar")), "on" == e && ($(".navbar-static-top").removeClass("navbar-static-top").addClass("navbar-fixed-top"), l.addClass("fixed-nav")), "on" == i && l.addClass("boxed-layout")
    //}
});